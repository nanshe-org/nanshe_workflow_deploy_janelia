...
* Open GitHub Desktop. Once open close it.
* Connect to the cluster `ssh -A login1.int.janelia.org`. (`-A` shares your computer's keys with the cluster required for cloning the private repo.)
